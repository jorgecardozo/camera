            ...
            <div className="auth-bg min-h-screen flex">
                ...
                <div className="hidden lg:flex lg:w-[45%] flex-col justify-between p-12
                    ...
                    <div className="relative">
                        ...
                        <h2 className="text-white text-4xl font-bold leading-tight mb-4">
                            Empezá a proteger<br />lo que importa.
                        </h2>
                        <p className="text-slate-400 text-lg leading-relaxed">
                            Configurá tus cámaras en minutos y recibí alertas en tiempo real desde cualquier lugar.
                        </p>
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 sm:px-12">
                    ...
                    <div className="lg:hidden mb-8 text-center">
                        ...
                        <p className="text-slate-500 text-sm mt-1">Crear nueva cuenta</p>
                    </div>

                    <div className="w-full max-w-sm">
                        <div className="mb-8 lg:block hidden">
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Crear cuenta</h2>
                            <p className="text-slate-500 text-sm mt-1">Completá tus datos para comenzar</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <p className="text-xs text-slate-400 dark:text-slate-500 pl-1">Mínimo 8 caracteres</p>
                            </div>
